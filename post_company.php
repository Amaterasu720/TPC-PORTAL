...
<div class="jumbotron text-center">
    ...
    <form action = "delete_post.php" novalidate>
        <button class = "btn btn-danger button1" type = "submit" onclick="return confirm('This post will be permanently deleted!')" name = "id" value = <?= htmlspecialchars($row["post"]) ?>><span class="glyphicon glyphicon-trash icon-white"></span></button>
    </form><br>
    <br>
    <?php } ?>
<!--     
    ...
    <br>
    <a href="eligible_stud.php" class="button" role="button">View Eligible Students</a><br><br>
