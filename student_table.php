    ...
    echo "yoo";
        ...
        foreach ($_POST as $k=>$r){
            ...
            if(substr($k,0,1)=='!'){
                ...
                header("Location: admin_student_insert.php");
            }
            else{
            // session_destroy();
            session_start();
...
<a href="admin.php" class="btn btn-default" role="button"><span class="glyphicon glyphicon-home"></span> HOME</a>
    ...
    if($row=mysqli_fetch_assoc($result)){
     ...
     $result1 = $mysqli->query($sql);
        ...
        while($row=mysqli_fetch_assoc($result1)){
            ...
            <td><button class="btn btn-danger" onclick="return confirm('This record will be deleted permanently!')" name=!<?= htmlspecialchars($roll)?>>DELETE</button></td>
